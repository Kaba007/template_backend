    ...
    <div className="space-y-2" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        {isDropdownOpen && !selectedOption && (
          <div className="absolute z-100 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-600 max-h-60 overflow-y-auto">
